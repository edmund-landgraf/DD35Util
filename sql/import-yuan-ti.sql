...
VALUES
    (@CreatureId, N'Mordenkainen Presents: Monsters of the Multiverse', N'Overview', NULL, NULL, N'Yuan-ti were originally humans transformed into serpent folk through ancient rituals. Some became a new people mixing human and snake characteristics, with serpentine traits such as a forked tongue, snake eyes, a snakelike nose, or another ophidian characteristic.', 5),
    ...
    (@CreatureId, N'Mordenkainen Presents: Monsters of the Multiverse', N'Size', NULL, NULL, N'You are Medium, about 5-7 feet tall, or Small, about 2-4 feet tall. You choose the size when you select this race.', 30),
